...
contract DITest is Test {
    ...
    string public issuer_did = "did:college:09fdd71c65e0dad736ac3fc201c49ecaf00b3840a544b5150c8aad68c58919aa";
    string public holder_did = "did:education:09fdd71c65e0dad736ac3fc201c49ecaf00b3840a544b5150c8aad68c58919aa";
    ...
    function test_ShouldRevertOnMaxDIDs() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(MAX_DIDs_Created.selector, user_dids));
        di.assignDID(msg.sender, issuer_did);
    }
