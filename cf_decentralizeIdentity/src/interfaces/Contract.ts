...
export interface DIContractInterface extends BaseContract {
    ...
    issueCredentials(did: string, credential: string): Promise<void>;
    getCredentials(did: string): Promise<string[]>;
...
export class DecentralizeIdentityContractInit {
    ...
    constructor() {
        ...
        const _contract:Contract = new ethers.Contract(contract_address, contract_abi, this.provider);
